...
<body id="message" onselectstart="return true;" ondragstart="return false;">
				...
				<div class="history-date">
					<ul>
						...
						<li class="green bounceInDown">
							<h3>
								<img src="/Yii2/frontend/web/message/logo100x100.jpg"> 
								<?php echo $msg->uname?><span><?=date('Y-m-d H:i:s',$msg->created_at) ?></span>
								<div class="clr"></div>
							</h3>
							<dl>
	...
	<script type="text/javascript" src="/Yii2/frontend/web/message/jquery.js"></script>
